...
public:
    ...
    void cities(City earth[48])
    {
        ...
        earth[2].connectTwo = &earth[1]; // Chicago
        earth[2].connectThree = &earth[3]; // New York
        
        earth[3].name = "New York";
        earth[3].connectOne = &earth[2]; // Montreal
        earth[3].connectTwo = &earth[4]; // Washington
        earth[3].connectThree = &earth[7]; // Madrid
        earth[3].connectFour = &earth[6]; // London
        ...
        earth[5].connectOne = &earth[1]; // Chicago
        earth[5].connectTwo = &earth[14]; // Miami
        ...
        earth[12].connectThree = &earth[47]; // Sydney
        earth[12].connectFour = &earth[13]; // Mexico City
        
        earth[13].name = "Mexico City";
        earth[13].connectOne = &earth[12]; // LA
        earth[13].connectTwo = &earth[1]; // Chicago
        earth[13].connectThree = &earth[14]; // Miami
        earth[13].connectFour = &earth[15]; // Bogota
        earth[13].connectFive = &earth[16]; // Lima
        
        earth[14].name = "Miami";
        earth[14].connectOne = &earth[13]; // Mexico City
        earth[14].connectTwo = &earth[5]; // Atlanta
        earth[14].connectThree = &earth[15]; // Bogota
        earth[14].connectFour = &earth[4]; // Washington
        
        earth[15].name = "Bogota";
        earth[15].connectOne = &earth[14]; // Miami
        earth[15].connectTwo = &earth[16]; // Lima
        earth[15].connectThree = &earth[13]; // Mexico City
        earth[15].connectFour = &earth[18]; // Sau Paulo
        earth[15].connectFive = &earth[17]; // Buenos Aires
        ...
        earth[17].connectOne = &earth[18]; // Sau Paulo
        ...
        earth[18].connectFour = &earth[17]; // Buenos Aires
        ...
        earth[20].connectFour = &earth[26]; // Cairo
        
        earth[21].name = "Johannesburg";
        earth[21].connectOne = &earth[20]; // Khartoum
        earth[21].connectTwo = &earth[22]; // Kinshasa
        ...
        earth[23].connectOne = &earth[16]; // Lima
        ...
        earth[26].connectFive = &earth[20]; //Khartoum
        ...
        earth[47].connectThree = &earth[12]; // LA
    }
};